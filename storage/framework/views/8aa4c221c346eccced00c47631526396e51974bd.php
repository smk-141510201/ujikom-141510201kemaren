...
<div class="container-fluid">
	...
	<br>
	<a href="<?php echo e(url('/Tunjangan/create')); ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o"></i>&nbsp;Tambah Data</a>
<br>
<br>
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td><center><a href="<?php echo e(url('Tunjangan', $data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></center></td>
			<td><center><a href="<?php echo e(route('Tunjangan.edit', $data->id)); ?>" class="btn btn-danger"><i class="fa fa-pencil-square-o"></i></a></center></td>
			<td><center>
