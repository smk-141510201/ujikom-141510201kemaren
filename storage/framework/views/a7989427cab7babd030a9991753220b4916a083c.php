...
<div class="container-fluid">
	<h1><b><i class="fa fa-database">&nbsp;</i>Data Kategori Lembur</b></h1>
	<br>
	<a href="<?php echo e(url('/Kategorilembur/create')); ?>" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>&nbsp;Tambah Data</a>
<br>
<br>
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td><center><a href="<?php echo e(url('Kategorilembur', $data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></center></td>
			<td><center><a href="<?php echo e(route('Kategorilembur.edit', $data->id)); ?>" class="btn btn-danger"><i class="fa fa-pencil-square-o"></i></a></center></td>
			<td><center>
