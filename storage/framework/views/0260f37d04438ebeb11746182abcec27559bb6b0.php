...
<h1><i class="fa fa-database"></i>&nbsp;<b>Data Pegawai</b></h1>
	<br>
	<a href="<?php echo e(url('/Pegawai/create')); ?>" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>&nbsp;Tambah Data</a>
<br>
<br>
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td><center><img src="<?php echo e(asset('/assets/image/'.$data->Photo)); ?>" height="100px" width="100px" class="img-circle"></center></td>
			<td><center><a href="<?php echo e(url('Pegawai', $data->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a></center></td>
			<td><center><a href="<?php echo e(route('Pegawai.edit', $data->id)); ?>" class="btn btn-danger"><i class="fa fa-pencil-square-o"></i></a></center></td>
			<td><center>
